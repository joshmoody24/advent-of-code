...
SumInvalidIds:
  ; start with all zeroes out of paranoia
  ld de, StartNum
  call SetLongToZero
  ld de, EndNum
  call SetLongToZero
...
; ParseFirstNumber
; ------------------------------
; IN:  HL = pointer to ASCII digits, e.g. "11-22,..."
; OUT: DE = parsed 16-bit value of the first number (here: 11)
;      HL = points at the '-' when finished
; CLobbers: A, B, DE, flags
ParseNumber:
  push af
  push bc
  push de
...
; Sets the 5 bytes of ram starting at de to 0
SetLongToZero:
  push af
  push bc
  ld c, 5
...
SECTION "Vars", WRAM0
; 5 byte little endian number, stores up to about 1 trillion
; We're going to call them "Long"
StartNum: ds 5 
EndNum: ds 5
CurrentNum: ds 5
